  ...
  return (
    ...
    >
      ...
      <RecordSection title="Details" cols={2}>
        ...
        <RecordField label="Mitarbeiter Frühschicht" value={getMitarbeitendeDisplayName(record.fields.mitarbeiter_fruehschicht)} format="text" />
        <RecordField label="Mitarbeiter Spätschicht" value={getMitarbeitendeDisplayName(record.fields.mitarbeiter_spaetschicht)} format="text" />
        <RecordField label="Notiz zum Tag" value={record.fields.notiz} format="longtext" className="md:col-span-2" />
      </RecordSection>
